...
#    
    ...
    echo "To upgrade your system type 'lenic upgrade' plus the codename of your FOLLOWING version."; echo ""
    ...
    echo "--- UPGRADES via lenic are only available, when your current system is debian 11 or newer! ---"
  fi
else
